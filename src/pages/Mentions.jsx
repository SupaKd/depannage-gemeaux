    ...
    <main className="mentions">
      ...
      <section>
        ...
        <p>
          ...
          du site depannage-gemeaux.fr l’identité des différents intervenants
          dans le cadre de sa réalisation et de son suivi :
        </p>
        <p>
          Propriétaire : Jérémy MORELLE EI – SIREN : 982 743 270 – 40 rue du Dr
          Corson – bât C – 22200 GUINGAMP.
        </p>
        <p>N° TVA Intracommunautaire : établissement non soumis à TVA</p>
        <p>Créateur : Spread Communication</p>
        <p>Responsable publication : Jérémy MORELLE – depannage-gemeaux@gmail.com</p>
        <p>Le responsable publication est une personne morale.</p>
        <p>Webmaster : Spread Communication – contact@spread-communication.com</p>
      ...
      <section>
        ...
        <p>
          L’utilisation du site depannage-gemeaux.fr implique l’acceptation
        ...
        <p>
          ...
          depannage-gemeaux.fr sont donc invités à les consulter de manière
          régulière.
        </p>
        <p>
          ...
          toutefois décidée par Spread Communication, qui s’efforcera alors de
          communiquer préalablement aux utilisateurs les dates et heures de
          l’intervention.
        </p>
        <p>
          Le site depannage-gemeaux.fr est mis à jour régulièrement par Jérémy
          MORELLE EI.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Le site depannage-gemeaux.fr a pour objet de fournir une information
          concernant l’ensemble des activités de la société.
        </p>
        <p>
          Jérémy MORELLE EI s’efforce de fournir sur le site
          depannage-gemeaux.fr des informations aussi précises que possible.
        </p>
        <p>
        ...
        <p>
          Tous les informations indiquées sur le site depannage-gemeaux.fr sont
          données à titre indicatif, et sont susceptibles d’évoluer.
        </p>
        <p>
          Par ailleurs, les renseignements figurant sur le site
          depannage-gemeaux.fr ne sont pas exhaustifs. Ils sont donnés sous
      ...
      <section>
        ...
        <p>
          Spread Communication est propriétaire des droits de propriété
        ...
        <p>
          ...
          préalable de : Spread Communication.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Spread Communication ne pourra être tenue responsable des dommages
          directs et indirects causés au matériel de l’utilisateur, lors de
          l’accès au site depannage-gemeaux.fr, et résultant soit de
        ...
        <p>
          Jérémy MORELLE EI ne pourra également être tenue responsable des
          dommages indirects (tels par exemple qu’une perte de marché ou perte
          d’une chance) consécutifs à l’utilisation du site
          depannage-gemeaux.fr.
        </p>
        <p>
          Des espaces interactifs (possibilité de poser des questions dans
          l’espace contact) sont à la disposition des utilisateurs. Jérémy
          MORELLE EI se réserve le droit de supprimer, sans mise en demeure
        ...
        <p>
          Le cas échéant, depannage-gemeaux.fr se réserve également la
      ...
      <section>
        ...
        <p>
          A l’occasion de l’utilisation du site depannage-gemeaux.fr, peuvent
          êtres recueillies : l’URL des liens par l’intermédiaire desquels
          l’utilisateur a accédé au site depannage-gemeaux.fr, le fournisseur
          d’accès de l’utilisateur, l’adresse de protocole Internet (IP) de
          l’utilisateur.
        </p>
        <p>
          En tout état de cause Jérémy MORELLE EI ne collecte des informations
          personnelles relatives à l’utilisateur que pour le besoin de certains
          services proposés par le site depannage-gemeaux.fr. L’utilisateur
          ...
          l’utilisateur du site depannage-gemeaux.fr l’obligation ou non de
        ...
        <p>
          ...
          depannage-gemeaux.fr n’est publiée à l’insu de l’utilisateur, échangée,
          transférée, cédée ou vendue sur un support quelconque à des tiers.
          Seule l’hypothèse du rachat de Jérémy MORELLE EI et de ses droits
      ...
      <section>
        ...
        <p>
          Le site depannage-gemeaux.fr contient un certain nombre de liens
          hypertextes vers d’autres sites, mis en place avec l’autorisation de
          Jérémy MORELLE EI.
        </p>
        <p>
          Cependant, Jérémy MORELLE EI n’a pas la possibilité de vérifier le
          contenu des sites ainsi visités, et n’assumera en conséquence aucune
          responsabilité de ce fait.
        </p>
        <p>
          La navigation sur le site depannage-gemeaux.fr est susceptible de
      ...
      <section>
        ...
        <p>
          ...
          depannage-gemeaux.fr est soumis au droit français. Il est fait
