...
function Home() {
  return (
    <main className="home">
      ...
      <div className="contact1"><FontAwesomeIcon icon={faBolt} /> Dépannage électricite</div>
      <div className="contact2">
        <a href="tel:+33769697279">
        07 69 69 72 79</a>
      </div>
      <div className="contact3"><FontAwesomeIcon icon={faLockOpen} /> Dépannage serrurerie</div>
    </section>
          ...
          <div className="container home-section2__wrapper">
            ...
            <div className="home-section2__text">
              ...
              <p>
                ...
                <strong>Morlaix</strong> et <strong>Callac</strong>.
              </p>
              <p>
              ...
              <p>
                Nous vous proposons des <strong>tarifs transparents</strong>,
                ajustés selon la complexité de l’intervention et votre
