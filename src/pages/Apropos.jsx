    ...
    <main className="apropos">
      ...
      <section className="apropos-section2">
        ...
        <div className="apropos-section2__text">
          ...
          <p>
            Nous couvrons principalement la moitié ouest des Côtes d’Armor, avec
            des interventions dans des villes comme Guingamp, Saint-Brieuc,
            Lannion, Morlaix, Callac et Paimpol. Notre engagement est de fournir
            des prestations de qualité, à des tarifs compétitifs, tout en
            assurant la sécurité et la satisfaction de nos clients. Grâce à
            notre expertise, nous sommes en mesure de vous conseiller sur les
            meilleures options pour sécuriser vos accès ou pour résoudre vos
            problèmes électriques.
          </p>
          <br />
          <p>
            Chez Dépannage Gémeaux, nous plaçons la satisfaction de nos clients
            au cœur de notre démarche. Chaque intervention est réalisée avec
            minutie et dans le respect des normes en vigueur. Vous avez une
            question ou besoin d’un conseil ? Notre équipe est à votre écoute
            pour vous accompagner et vous offrir la tranquillité d’esprit que
            vous méritez.
          </p>
